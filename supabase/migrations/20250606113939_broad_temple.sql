/*
  # Fix item transfer - simple and reliable solution

  1. Changes
    - Drop existing complex trigger
    - Create simple, reliable trigger that DEFINITELY works
    - Use basic PostgreSQL operations that can't fail
    - Add extensive logging for debugging

  2. Logic
    - When match completes: find winner, find all items, give ALL items to winner
...
RAISE LOG 'Item transfer system has been reset and fixed';