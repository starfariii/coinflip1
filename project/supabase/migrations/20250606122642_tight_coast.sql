/*
  # Fix join_match_atomic function

  1. Function Updates
    - Drop existing join_match_atomic function if it exists
    - Create new join_match_atomic function with proper return type
    - Handle RLS policies correctly with SECURITY DEFINER
    - Implement atomic operations with row locking
...
-- Create the join_match_atomic function
